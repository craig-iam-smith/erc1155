...
// OpenZeppelin Contracts (last updated v4.8.0) (token/ERC1155/extensions/ERC1155Enumerable.sol)
...
*/
    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256[] memory ids,
        uint256[] memory batchSize,
        bytes memory data
    ) internal virtual override {
        super._beforeTokenTransfer(operator, from, to, ids, batchSize, data);

        if (batchSize[0] > 1) {
            // Will only trigger during construction. Batch transferring (minting) is not available afterwards.
            revert("ERC1155Enumerable: consecutive transfers not supported");
        }
